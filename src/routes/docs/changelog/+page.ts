...
const changes: Change[] = [
	...
	},
	{
		...
		changes: [
			"You can now export all tables to csv",
			"Added linux support for the ikusa-logger",
		],
		author: oracle,
	},
	{
	...
	},
	{
		...
		changes: [
			"Fix open recording issue",
			"Fix overflow on with larger screen fonts",
		],
		author: oracle,
	},
	{
	...
	},
	{
		...
		changes: [
			"Improved issues & performance of charts",
			"Added war class chart & table",
		],
		author: oracle,
	},
	{
