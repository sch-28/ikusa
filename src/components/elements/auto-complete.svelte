...
<Input bind:value on:change {required} {placeholder} bind:input />
<div
	class="border border-gray-600 mt-1 absolute bg-gray-700 z-50 rounded-lg overflow-hidden {suggestions.length === 0 &&
		'hidden'}"
